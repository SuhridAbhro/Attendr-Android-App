    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(AdminView.this, LoginActivity.class);
        ...
        webView.loadUrl("https://attendanceproject.herokuapp.com/admin");
        ...
        webView.setWebViewClient(new WebViewClient()
        {
            ...
            public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
                ...
                webView.loadUrl("https://attendanceproject.herokuapp.com/admin/login/");
                AlertDialog alertDialog = new AlertDialog.Builder(AdminView.this).create();
